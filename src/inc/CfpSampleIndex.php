<?php
/**
 * Classes to represent the sample index XML files
 *
 * This file contains the class CfpSampleIndex which is used to access and
 * validate the sample index XML files.
 *
 * PHP version 5.3.x
 *
